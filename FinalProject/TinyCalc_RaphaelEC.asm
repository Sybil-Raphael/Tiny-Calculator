...
variables DWORD 26 DUP(0)                                               ; array for A to Z
invalidVarMsg BYTE "Invalid variable name. Must be A-Z.", 0Dh, 0Ah, 0
;operand1Prompt BYTE 0Dh, 0Ah, "Enter first operand: ", 0
;operand2Prompt BYTE "Enter second operand: ", 0
addMsg BYTE 0Dh, 0Ah, "You selected Addition.", 0
subMsg BYTE 0Dh, 0Ah, "You selected Subtraction.", 0
mulMsg BYTE 0Dh, 0Ah, "You selected Multiplication.", 0
divMsg BYTE 0Dh, 0Ah, "You selected Division.", 0
modMsg BYTE 0Dh, 0Ah, "You selected Modulo.", 0
...
GetOpType:
    ...
    mov edx, OFFSET invalidOperationMsg                                 ; offset, points to invalidOperationMsg
    call WriteString                                                    ; displays invalidOperationMsg
    call Crlf                                                           
    jmp GetOpType                                                       
...
;Returns: nothing 
;-----------------------------------------------------------------
mov edx, OFFSET menuMsg                                                 ; displays menu
call WriteString
call ReadChar
...
cmp operation, '='                                                      ; compares operation to '='
je DoAssignment                                                         ; if equal, jumps to DoAssignment
